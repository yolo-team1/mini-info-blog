...
<main class="form-signin w-auto m-auto">
      ...
      <?php endif; ?> 
  <form class="form-signin w-auto" method="post" action="<?php echo base_url() ?>admin/signup/signup" enctype="multipart/form-data"> 
    ...
    <div class="form-floating">
      ...
      <label for="floatingInput" value="<?= set_value('name'); ?>">Nama</label>
    ...
    <div class="form-floating">
      <input type="password" class="form-control" id="floatingPassword" name="password_confirm" placeholder="Konfirmasi Password">
      <label for="floatingPassword value="<?= set_value('password_confirm'); ?>"> Konfirmasi Password</label>
    ...
    <a href="<?php echo base_url() ?>admin/login" class="btn btn-secondary w-100 py-2 mt-2">Masuk</a>
